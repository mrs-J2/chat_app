...
import 'package:chat_app_main/models/user_model.dart';
import 'package:chat_app_main/pages/chat_page.dart';
...
class FriendsPage extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: controller.allUsers.isEmpty
          ...
          : RefreshIndicator(
              ...
              child: ListView(                     // <-- ListView gives physics
                children: [
                  // ----- FRIENDS -----
                  const Padding(
  ...
  // -----------------------------------------------------------------
  // Other-user tile (unchanged logic, just tiny clean-up)
  // -----------------------------------------------------------------
        ...
        if (ctrl.friends.contains(user.uid)) {
          ...
          showDialog(
            ...
            builder: (_) => AlertDialog(
              ...
              actions: [IconButton(icon: const Icon(Icons.approval), onPressed:() => Navigator.pop)],
            ),
          );
        }
      },
